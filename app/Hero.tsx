...
import heroImage from "../public/car.webp";

export default function Hero() {
  return (
    <div className='relative overflow-hidden grid grid-cols-2 items-center'>
      <div className='cont py-24'>
        <div className='max-w-xl'>
          <h1 className='h1 text-light-900'>Pass Your Test First Time</h1>
